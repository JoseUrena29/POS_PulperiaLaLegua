...
c.TipoCompra,c.NumeroCompra,c.MontoNeto,c.Descuento,c.Subtotal,c.IVA,c.Total,convert(char(10),c.FechaRegistro,103)[FechaRegistro],convert(char(8), c.FechaRegistro, 108)[HoraRegistro]
from COMPRA c
